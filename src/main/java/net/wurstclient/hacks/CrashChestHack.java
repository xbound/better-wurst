...
{
	private final SliderSetting size = new SliderSetting("Size", 40000, 1, 1024*1024, 1, ValueDisplay.INTEGER);
	...
	public void onEnable()
	{
		...
		for(int i = size.getValueI(); i > 0 ; --i)
			nbtList.add(new NbtList());
		//may be detected by server
		nbtCompound.put("Lock", nbtList);
